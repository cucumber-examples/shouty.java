...
public class ShoutSteps {
    ...
    public void shouter_shouts(String shouter) throws Throwable {
        shoutyHelper.shouty.shout(shouter, ARBITRARY_MESSAGE);
    }

    @Then("^(\\w+) should hear Sean")
    public void lucy_should_hear_sean(String listener) throws Throwable {
        Map<String, List<String>> messagesHeard = shoutyHelper.shouty.getShoutsHeardBy(listener);
    ...
    public void lucy_should_not_hear_oscar() throws Exception {
        Map<String, List<String>> messagesHeard = shoutyHelper.shouty.getShoutsHeardBy("Lucy");
    ...
    public void lucy_should_hear_shouts_from_sean(int shouts) throws Throwable {
        Map<String, List<String>> messagesHeardBy = shoutyHelper.shouty.getShoutsHeardBy("Lucy");
